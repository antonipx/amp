...
set output 'jjdb.png'
plot 'jjdb.dat' using 1:2 with lines linestyle 3 title 'IOPROFILE=DB', \
            '' using 1:3 with lines linestyle 2 title '--journal', \
            '' using 1:4 with lines linestyle 1 title 'Journal Dev + --journal + IOPROFILE=DB'
