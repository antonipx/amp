...
set output 'jd.png'
plot 'jd.dat' using 1:2 with lines linestyle 2 title 'PX VOL', \
            '' using 1:3 with lines linestyle 3 title 'IOPROFILE=DB', \
            '' using 1:4 with lines linestyle 1 title '--journal'
